...
export const mapLocations: SiteLocation[] = [
  ...
  },
  {
    ...
    address_id: 'Jl. Alun-Alun Utara, Panembahan, Kraton',
    address_en: 'Jl. Alun-Alun Utara, Panembahan, Kraton',
  ...
  },
  {
    ...
    description_id: 'Cafe di alam terbuka dengan view pegunungan yang epic! Tempat legendaris dengan suasana vintage dan kopi racikan tradisional yang kental.',
    description_en: 'Open-air cafe with epic mountain views! Legendary spot with vintage atmosphere and thick traditional brewed coffee.',
    category: 'culinary',
    subcategory: 'cafe',
    coordinates: { lat: -7.67013, lng: 110.42128 },
    address_id: 'Pakem, Sleman',
    address_en: 'Pakem, Sleman',
    openingHours: '07:00 - 22:00',
    priceRange: 'Rp 15.000 - Rp 50.000',
    facilities: ['Parkir', 'Toilet', 'Outdoor Seating', 'Wi-Fi'],
    googleMapsUrl: 'https://goo.gl/maps/kopiklotok',
  },
  {
    id: 'the-westlake-resto-cafe',
    name_id: 'The Westlake Resto & Cafe',
    name_en: 'The Westlake Resto & Cafe',
    description_id: 'Cafe tepi danau dengan sunset view yang bikin feed IG kamu makin kece! Menu western dan Indonesian fusion.',
    description_en: 'Lakeside cafe with sunset views that will level up your IG feed! Western and Indonesian fusion menu.',
    category: 'culinary',
    subcategory: 'cafe',
    ...
    facilities: ['Parkir', 'Toilet', 'Outdoor Seating', 'Wi-Fi', 'Live Music'],
    googleMapsUrl: 'https://goo.gl/maps/westlake',
  },
  {
    id: 'roaster-and-bear',
    name_id: 'Roaster & Bear',
    name_en: 'Roaster & Bear',
    description_id: 'Hidden gem dengan vibe industrial aesthetic. Sering ada live music weekend! Coffee shop modern dengan specialty coffee berkualitas tinggi.',
    description_en: 'Hidden gem with industrial aesthetic vibes. Live music on weekends! Modern coffee shop with high-quality specialty coffee.',
    category: 'culinary',
    subcategory: 'coffee-shop',
    coordinates: { lat: -7.78442, lng: 110.36704 },
    address_id: 'Jl. Margo Utomo, Yogyakarta',
    address_en: 'Jl. Margo Utomo, Yogyakarta',
    openingHours: '08:00 - 23:00',
    priceRange: 'Rp 20.000 - Rp 60.000',
    facilities: ['Parkir', 'Toilet', 'Wi-Fi', 'Live Music', 'Coworking Space'],
    googleMapsUrl: 'https://goo.gl/maps/roasterbear',
  },
  {
    id: 'warung-bu-ageng',
    name_id: 'Warung Bu Ageng',
    name_en: 'Warung Bu Ageng',
    description_id: 'Makan tradisional enak dengan harga mahasiswa banget. Warung makan sederhana dengan masakan rumahan yang lezat dan harga terjangkau.',
    description_en: 'Delicious traditional food at student prices. Simple eatery with delicious home-cooked food at affordable prices.',
    category: 'culinary',
    subcategory: 'warung',
    coordinates: { lat: -7.818075026450364, lng: 110.3641136935998 },
    address_id: 'Jl. Tirtodipuran No.13, Mantrijeron',
    address_en: 'Jl. Tirtodipuran No.13, Mantrijeron',
    openingHours: '10:00 - 21:00',
    priceRange: 'Rp 10.000 - Rp 30.000',
    facilities: ['Parkir', 'Toilet'],
    googleMapsUrl: 'https://goo.gl/maps/buageng',
  },
